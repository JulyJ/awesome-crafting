---
layout: single
title: "Soldering for Crafters: Complete Electronics Basics Guide"
permalink: /skill-building/soldering-for-crafters-electronics-basics/
sidebar:
  nav: side
date: 2025-01-26
...
seo:
  ...
  type: "article"
  keywords: [soldering guide, electronics for crafters, learn soldering, LED projects, circuit basics, soldering techniques, electronics tutorial, beginner soldering]
  canonical_url: "https://craftingsupply.ca/skill-building/soldering-for-crafters-electronics-basics/"
---
...
More voltage = more current (if resistance stays same)
More resistance = less current (if voltage stays same)
...
**Example**: 5V supply, red LED (2V forward voltage), 20mA current:
(5V - 2V) ÷ 0.02A = 3V ÷ 0.02A = 150Ω
...
Makers like [Lumicry](https://lumicry.com/) demonstrate the stunning results possible when you master soldering and electronics: luminous acrylic displays where LEDs are seamlessly integrated into precision-cut acrylic, creating artwork that's as much engineering as it is craft. These projects require:
